...
actor class RoboKicks (_name: Text, _symbol: Text, _maxSupply: Nat, _owner: Principal) {
    ...
    type StorageActor = actor {
        addRecord : (caller: Principal, op: Operation, from: ?Principal, to: ?Principal, tokeInd: Nat, price: ?Nat64, timestamp: Time.Time) -> async Nat;
    };
